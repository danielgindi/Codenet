...
namespace Codenet.Drawing.Quantizers.Octree;
...
internal class OctreeNode
{
    ...
    public NeatColor Color
    {
        get
        {
            ...
            {
                result = pixelCount == 1 ?
                    NeatColor.FromARGB(255, (byte)red, (byte)green, (byte)blue) :
                    NeatColor.FromARGB(255, (byte)(red / pixelCount), (byte)(green / pixelCount), (byte)(blue / pixelCount));
            }
            else
            {
    ...
    public void AddColor(NeatColor color, Int32 level, OctreeQuantizer parent)
    {
    ...
    /// <param name="level">The level.</param>
    /// <returns></returns>
    public Int32 GetPaletteIndex(NeatColor color, Int32 level)
    {
        Int32 result;
