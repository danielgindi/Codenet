...
namespace Codenet.Drawing.Quantizers.Ditherers;
...
public abstract class BaseColorDitherer : IColorDitherer
{
    ...
    protected byte GetClamped8bColorElementWithError(Int32 colorElement, Single factor, Int32 error)
    {
        Int32 result = Convert.ToInt32(colorElement + factor * error);
        return GetClamped8bColorElement(result);
    }

    protected byte GetClamped8bColorElement(Int32 colorElement)
    {
    ...
    /// </summary>
    protected abstract Boolean OnProcessPixel(PixelAccess sourcePixel, PixelAccess targetPixel);
    ...
    /// </summary>
    public IList<System.Drawing.Point> GetPointPath(Int32 width, Int32 heigth)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public IList<System.Drawing.Point> GetPointPath()
    {
        return null;
    }
    ...
    /// </summary>
    public bool ProcessPixel(PixelAccess sourcePixel, PixelAccess targetPixel)
    {
