...
namespace Codenet.Drawing.Quantizers.ColorCaches.LocalitySensitiveHash
{
    ...
    public class LshColorCache : BaseColorCache
    {
        ...
        private Int64 GetColorBucketIndex(NeatColor color)
        {
        ...
        private BucketInfo GetBucket(NeatColor color)
        {
        ...
        protected override void OnGetColorPaletteIndex(NeatColor color, out Int32 paletteIndex)
        {
            ...
            {
                Int32 index = 0;
                Int32 colorIndex = ColorModelHelper.GetEuclideanDistance(color, ColorModel, new List<NeatColor>(bucket.Colors.Values));
