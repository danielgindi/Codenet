...
public class UniformQuantizer : BaseColorQuantizer
{
    ...
    protected override void OnAddColor(NeatColor color, UInt32 key, Int32 x, Int32 y)
    {
        ...
        Int32 redIndex = color.Red >> 5;
        Int32 greenIndex = color.Green >> 5;
        Int32 blueIndex = color.Blue >> 6;

        redSlots[redIndex].AddValue(color.Red);
        greenSlots[greenIndex].AddValue(color.Green);
        blueSlots[blueIndex].AddValue(color.Blue);
    }
    ...
    protected override List<NeatColor> OnGetPalette(Int32 colorCount)
    {
        ...
        List<NeatColor> optimizedPalette = base.OnGetPalette(colorCount);
